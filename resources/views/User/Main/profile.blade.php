...
<body class="bg-gray-200">
                    ...
                    <div class="w-full bg-white mt-6">
                        <div class="information  w-full px-4 py-4">
                            ...
                            <div class="w-full" id="no-edit">
                                @include('/User/component/Profile/Information', ['profile' => $profile])
                            </div>
                            <div class="w-full hidden" id="form-edit">
                                @include('/User/component/Profile/EditInformation', ['profile' => $profile])
                            </div>
                            <div class="w-full hidden" id="change-password">
                                @include('/User/component/Profile/ChangePassword')
                            </div>
                        </div>
                        <div class="information w-full px-4 hidden">
                            ...
                            <div class="w-full mt-8" id="allAddress">
                                @include('/User/component/Address/allAddress',['addressOfCustomer' =>
                    ...
                    <div class="w-full">
                        <div class="information w-full hidden border border-gray-300">
                            ...
                            <div class="w-full" id="allOrder">
                                @include('/User/component/Profile/OrderCustomer', ['orderCustomer' => $orderCustomer])
                            </div>
                        </div>
                    </div>
                    <div class="w-full">
                        <div class="information w-full hidden border border-gray-300">
                            ...
                            <div class="w-full" id="allOrderCancel">

                                @include('/User/component/Profile/OrderCustomerCancel', ['orderCancel' => $orderCancel])
                            </div>
                        </div>
                    </div>
                    <div class="detail-order-customer w-full hidden">
    ...
    <div class="content w-full h-screen fixed top-0 right-0 bg-black bg-opacity-50" style="display: none;">
        ...
        <div class="form-edit-cart w-2/5 m-auto border border-gray-300 p-4 absolute top-64 bg-white" id="myEdit"
            ...
            @include('/User/component/Address/form_edit_address', ['city' => $city, 'district'=>$district, 'commune'=>
            $commune,
            'infor' => $infor])
        </div>
    </div>
