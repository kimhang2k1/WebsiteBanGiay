            ...
            <div class="w-full flex">
                ...
                <div class="w-1/2">
                    <div class="w-full mb-4">
                        <p class="font-bold text-2xl" id="TenSP">{{ $pr->TenSP }}</p>
                    </div>
                    ...
                    <div class="w-full my-8">
                        ...
                        <ul class="flex space-x-4 mt-2 font-bold">
                            @if($pr->IDNhomSP == 'NSP00001' || $pr->IDNhomSP == 'NSP00002')
                            @foreach($size as $s)
                            ...
                            @endforeach
                            @elseif($pr->IDNhomSP == 'NSP00003')

                            @foreach($sizeOther as $s)
                            <li class="size__product active border border-gray-300 w-24 leading-10 text-center rounded-lg"
                                onclick="getSize(this, '{{ $s->IDSize}}') ">
                                <span class=" text-sm">{{ $s->SoSize}}</span>
                            </li>
                            @endforeach
                            @endif
                ...
                <div class=" tabcontent w-full mt-4 leading-9 hidden " id="review">
                    <div class="w-full">
                        ...
                        <div class="w-full mt-4" id="comment">
                            @include('/User/component/Product/AllComment', ['comment' => $comment])
                        </div>
                    </div>
...
<script>
document.title = document.getElementById('TenSP').innerText;
</script>
