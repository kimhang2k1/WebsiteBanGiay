<div class="form-add-cart w-2/5 m-auto border border-gray-300 p-4 absolute top-64 bg-white hidden"
    ...
    <div class="print-error-msg" style="display:none;">
        <ul
            style="list-style: none;border: 1px solid lightpink;background-color: lightpink;border-radius: 5px;color: red;text-align:left;">
        </ul>
    </div>
    <form action="">
        <div class="w-full flex space-x-4 px-12 mt-8 mb-4 text-sm">
            <div>
                <input class="check w-60 h-10 border border-gray-300 pl-4 " type="text" name="HoTen"
                    placeholder="Họ và Tên" onchange="stateHandle(this)" required />
                @error('HoTen')
                <span> {{ $message }}</span>
                @enderror
            </div>
            <div>
                <input class=" check w-60 h-10 border border-gray-300 pl-4 " type="text" name="SDT"
                    placeholder="Số điện thoại" onchange="stateHandle(this)" required />
            </div>
        </div>
        <fieldset class="border border-gray-300 h-12 text-sm m-auto ml-12 px-2 text-gray-400 relative"
            style="width: 85%;">
                ...
                <div class="w-full flex">
                    <div class="w-4/5" onclick="openBoxTab()">
                        <div class="text-black leading-6 flex">
                            <option class=" pr-1" id="city_address" onchange="stateHandle(this)"></option>
                            <option class=" pr-1 leading-6" id="district_address" onchange="stateHandle(this)">
                            </option>
                            <option class=" leading-6" id="village" onchange="stateHandle(this)"></option>
        ...
        <div class="w-full text-sm px-12 mt-4 mb-4 ">
            <input class="check h-10 border border-gray-300 pl-4 " style="width: 31rem;" type="text" name="SoNha"
                placeholder="Địa Chỉ cụ thể" onchange="stateHandle(this)" required />
        </div>
        ...
        <div class="w-full  px-12 mt-4 mb-4 flex justify-end text-sm">
            ...
            <div>
                <button type="submit"
                    ...
                    onclick="addToAddress(event)" disabled>Hoàn
                    Thành</button>
            </div>
        </div>
    </form>
