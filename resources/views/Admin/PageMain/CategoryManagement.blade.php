            ...
            <div class="w-4/5">
                ...
                <div class="w-full border-2 border-gray-100 bg-white font-timenewroman management-category">
                    ...
                    <div class="px-4" id="page_category">
                        @include('Admin/component/CategoryProduct/CategoryProduct', ['category'=>$category])
                    </div>
                </div>
                ...
                <div class="form-edit-category w-1/2 mt-6 px-4 m-auto hidden">
                    @include('/Admin/component/CategoryProduct/FormEditCategoryProduct', ['informationCategory'=>
                    $informationCategory])
                </div>
            </div>
        </div>
