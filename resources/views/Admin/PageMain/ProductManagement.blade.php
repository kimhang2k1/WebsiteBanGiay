        ...
        <div class="w-full flex ">
            ...
            <div class="w-4/5">
                        ...
                        <div class="flex justify-end" style="width: 30%;">
                            <div class="insert ">
                                <button class="ring-2 text-white w-40 leading-8 rounded-sm text-sm"
                                    style="background-color:#2e6da4;" type="button" onclick="openFormAdd('product')">
                                    <i class="fas fa-plus-circle"></i> &nbsp;&nbsp;Thêm sản phẩm </button>
                            </div>
                        </div>
                    </div>
                    <div class="px-4" id="product">
                        @include('Admin/component/Product/AllProductInShop', ['product' => $product])
                    </div>
                    <div class="w-full mt-4">
                ...
                <div class="form-edit-product w-full mt-6 px-4 hidden">
                    @include('/Admin/component/Product/FormEditProduct', ['informationProduct' => $informationProduct,
